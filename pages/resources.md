...
[Here](https://cran.r-project.org/doc/contrib/Paradis-rdebuts_en.pdf) is a tutorial to learn the basics of R.
...
For improved visualization of effects, we recommend using plots from the estimation statistics [website](https://www.estimationstats.com/#/). The rationale for these plots is detailed [here](https://www.nature.com/articles/s41592-019-0470-3)

### Overlays
For overlays, we prefer to use mricron (2D plots) or mricro_gl for 3D rendered images. We favour colour codes which are [colour-blind friendly](https://www.color-blindness.com/coblis-color-blindness-simulator/).
...
The previous dataset were made available on the [xnat](https://central.xnat.org/) platform.
...
### Codes
In addition to making our dataset available, we will seek to make codes available with future publications. Repositories for our lab is found [here](https://github.com/grandjeanlab).
